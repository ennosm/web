...
$query = mysqli_query($koneksi, "SELECT * FROM berita WHERE idberita = '$idberita'");
                    ...
                    <nav class="navbar navbar-light navbar-expand-xl">
                        ...
                        <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top">
                                ...
                                <a href="detail-page.php" class="nav-item nav-link active">Halaman Detail</a>
                                
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Kategori</a>
                                    <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                        <a href="#" class="dropdown-item">Politik</a>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <ol class="breadcrumb justify-content-start mb-4">
                    ...
                    <li class="breadcrumb-item active text-dark">Halaman Tunggal</li>
                </ol>
                <div class="row g-4">
                    <div class="col-lg-8">
                        <?php 
                                $sql = mysqli_query($koneksi, "SELECT idberita, judulberita, coverberita, isiberita, penulisberita, tanggalberita, statusberita, waktuberita, GROUP_CONCAT(namakategori) AS kategoriberita FROM berita LEFT JOIN kategoriberita USING(idberita) LEFT JOIN kategori USING(idkategori) GROUP BY berita.idberita LIMIT 1");
                        ?>
                        <div class="mb-4">
                            <a href="#" class="h1 display-5"><?php echo $data['judulberita'];?></a>
                        </div>
                        <div class="position-relative rounded overflow-hidden mb-3">
                            <img src="admin/cover/<?php echo $data['coverberita']; ?>" class="img-zoomin img-fluid rounded w-100" alt="">
                        </div>
                        <?php echo $data['isiberita']; ?>
                        <div class="tab-class">
                        </div>
                    </div>
                    <div class="col-lg-4">
