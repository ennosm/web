...
<html lang="id">
    ...
    <head>
        <meta charset="utf-8">
        <title>Berita - Free HTML Magazine Template</title>
            ...
            <div class="container py-5">
                <div class="bg-light rounded p-5">
                    <div class="row g-4">
                        <div class="col-lg-5">
                            <div class="">
                                <h1 class="mb-4">Layanan Pelanggan Umum & Dukungan Teknis</h1>
                                <p class="mb-4">Formulir kontak saat ini tidak aktif. Dapatkan formulir kontak yang berfungsi dan berfungsi dengan Ajax & PHP dalam beberapa menit. Cukup salin dan tempel file, tambahkan sedikit kode dan selesai. Unduh sekarang. <a href="https://htmlcodex.com/contact-form">Unduh Sekarang</a>.</p>
                                <div class="rounded">
                        ...
                        <div class="col-lg-7">
                            <form action="" class="mb-4">
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <input type="text" class="w-100 form-control border-0 py-3" name="name" placeholder="Nama Anda">
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="email" class="w-100 form-control border-0 py-3" name="email" placeholder="Masukkan Email Anda">
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" class="w-100 form-control border-0 py-3" name="phone" placeholder="Masukkan No Hp">
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" class="w-100 form-control border-0 py-3" name="subject" placeholder="Subjek">
                                    </div>
                                    <div class="col-12">
                                        <textarea class="w-100 form-control border-0" rows="6" cols="10" placeholder="Pesan Anda"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <button class="w-100 btn btn-primary form-control py-3" type="submit">Kirim Sekarang</button>
                                    </div>
                                </div>
                            </form>
                            <div class="row g-4">
                                <div class="col-xl-6">
                                    <div class="d-flex p-4 rounded bg-white">
                                        ...
                                        <div>
                                            <h4>Alamat</h4>
                                            <p class="mb-0">123 Surakarta Jawa Tengah. Indonesia</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-9">
                            <div class="d-flex position-relative rounded-pill overflow-hidden">
                                ...
                                <button type="submit" class="btn btn-primary border-0 py-3 px-5 rounded-pill text-white position-absolute" style="top: 0; right: 0;">Berlangganan Sekarang</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6 col-xl-3">
                        <div class="footer-item-1">
                            ...
                            <p class="text-secondary line-h">Email: <span class="text-white">e@gmail.com</span></p>
                            <p class="text-secondary line-h">No Hp: <span class="text-white">+6228 4567 8910</span></p>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="footer-item-2">
                            <div class="d-flex flex-column mb-4">
                                <h4 class="mb-4 text-white">Tulisan Terbaru</h4>
                                <a href="#">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column ps-4">
                                            <p class="text-uppercase text-white mb-3">Gaya Hidup</p>
                                            <a href="#" class="h6 text-white">
                                            Dapatkan pasar pembicaraan terbaik, berita.
                                            </a>
                                            <small class="text-white d-block"><i class="fas fa-calendar-alt me-1"></i> 02 Juli, 2024</small>
                                        </div>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="d-flex flex-column text-start footer-item-3">
                            ...
                            <a class="btn-link text-white" href=""><i class="fas fa-angle-right text-white me-2"></i> Majalah</a>
                            <a class="btn-link text-white" href=""><i class="fas fa-angle-right text-white me-2"></i> Gaya Hidup</a>
